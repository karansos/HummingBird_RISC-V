...
# read_milkyway -r -no_pg -libname WORK -cell_name ${DESIGN_NAME}_DCT ${MW_DESIGN_LIBRARY}

if { $ICC_INIT_DESIGN_INPUT == "MW" } {
  read_milkyway -r -no_pg -libname WORK -cell_name ${ICC_INPUT_CEL} ${MW_DESIGN_LIBRARY}
}
...
read_verilog -i $SOURCE_DIR/$DESIGN_NAME.output.v 
