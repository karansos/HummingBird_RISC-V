...
set DCRM_CHECK_TIMING_REPORT                            ${DESIGN_NAME}.check_timing.rpt
...
# constraints report added by JAGDISH GAUR on TUE 19 JUL 2022
set DCRM_ATTRIBUTES_REPORT				${DESIGN_NAME}.attributes.rpt
